...
from db.db import db_get_figi, get_all_tickers, get_alligator, get_t_token
from bot.bot import bot
from telebot import types
from graphics.alligator_graph import plot_alligator
    ...
    if token is not None:
        ...
        if not tickers:
            ...
            for ticker in tickers:
                button = types.InlineKeyboardButton(text=str(ticker[0]), callback_data=f'mls_alligator_ticker_{ticker[0]}')
