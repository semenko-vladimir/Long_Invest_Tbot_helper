# Tbot - Торговый бот для Тинькофф Инвестиций

## Обзор проекта

Tbot - это автоматизированный торговый бот для работы с Тинькофф Инвестиции API. Приложение состоит из FastAPI бэкенда и Telegram бота, который предоставляет удобный интерфейс для управления торговыми стратегиями, получения уведомлений о состоянии рынка, анализа портфеля и многого другого.
...
- 📝 **Управление инструментами** (акции, облигации, ETF)
